...
function App() {
  return (
    <div className="transition duration-200 dark:bg-zinc-900">
      <div className="flex flex-col h-screen md:container md:mx-auto gap-4">
        ...
        <div className="flex-grow">
          <div className="flex flex-col h-full md:flex-row gap-4">
            <div className="bg-zinc-200 dark:bg-zinc-800 dark:border dark:border-zinc-700 rounded-3xl md:w-1/3 p-5">
              <LeftSide />
            </div>
            <div className="bg-zinc-200 dark:bg-zinc-800 dark:border dark:border-zinc-700 rounded-3xl md:w-2/3 p-5">
              <RightSide />
            </div>
          </div>
        </div>
